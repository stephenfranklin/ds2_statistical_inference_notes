...
- The likelihood is
  ...
  $$
    - which says, "The likelihood corresponding to the value of 1 (a success) which we observed is equal to $\theta$."
- Therefore, ${\cal L}(.5, 1) / {\cal L}(.25, 1) = 0.5/0.25 = 2$, 
    - which says, "Therefore, our likelihood for 0.5 (a fair coin) relative to the likelihood that the coin is biased (with a success probability of 0.25) is equal to 2."
...
- Now consider ${\cal L}(.5, 1, 3) / {\cal L}(.25, 1, 3) =
\frac{0.5^3(1 - 0.5)}{0.25^3(1 - 0.25)} = 5.33$
...
- note: In this example we used the letter $p$ instead of $\theta$.
...
- note: the horizontal lines are at 1/8th and 1/16th likelihood.  See lecture.
